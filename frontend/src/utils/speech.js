...
export const speakText = (text, lang = "en", onStart, onEnd) => {
  ...
  // Voice narration support is strictly restricted to Hindi and English
  const isHindi = lang === "hi" || (typeof lang === "string" && lang.startsWith("hi"));
  const isEnglish = lang === "en" || (typeof lang === "string" && lang.startsWith("en"));
  ...
  if (bestVoice && (!isHindi || gotRealHindiVoice)) {
  ...
  } else if (isHindi && !gotRealHindiVoice) {
