...
export default function RecordBookScreen({ 
  ...
  const handleReadSummary = () => {
    ...
    const speech = lang === 'hi'
      ? `किसान रिकॉर्ड बुक। आपके पास कुल ${count} प्रविष्टियां दर्ज हैं। नया रिकॉर्ड जोड़ने के लिए नीचे दिए गए प्लस बटन को दबाएं।`
      : `Farm Record Book. You have ${count} total activity records. Tap the plus button at bottom right to add a new treatment or spray log.`;
    onSpeakText(speech);
  };
  ...
  return (
    <div className="space-y-4 pb-28 relative">
      ...
      {/* 4. FLOATING "+" BUTTON (Large, Finger-Friendly 56px Touch Target) */}
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 animate-fadeIn">
          <div className="w-full max-w-md bg-white rounded-t-3xl sm:rounded-3xl p-5 shadow-2xl border border-[#e5dcce] max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddRecord} className="space-y-4">
              ...
              {/* Action Type Picker with Simple Big Icons */}
              <div>
                <label className="block text-xs font-bold text-[#495949] mb-1.5">
                  {t.records.type}
                </label>
